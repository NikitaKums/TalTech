...
namespace WebApp.Areas.Admin.Controllers
{
    ...
    public class ProductsReturnedController : Controller
    {
        ...
        {
            var productReturned = await _bll.ProductsReturned.AllAsync();
        ...
        public async Task<IActionResult> Create(int? id)
        {
            var vm = new ProductReturnedCreateViewModel()
            {
                ...
                ReturnSelectList = new SelectList(await _bll.Returns.AllAsync(), nameof(Return.Id), nameof(Return.Description))
            };
        ...
        public async Task<IActionResult> Create(ProductReturnedCreateViewModel vm)
        {
            ...
            vm.ReturnSelectList = new SelectList(await _bll.Returns.AllAsync(), nameof(Return.Id), nameof(Return.Description));
