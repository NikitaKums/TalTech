...
namespace WebApp.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string sortOrder, string currentFilter, string searchString, int? pageNumber)
        {
            ...
            var product = await _bll.Products.AllAsync(sortOrder, searchString, pageNumber ?? 1, 10);
            return View(PaginatedList<BLL.App.DTO.DomainLikeDTO.Product>.Create(product, pageNumber ?? 1, 10, 
                await _bll.Products.CountDataAmount(searchString)));
        }
        ...
        public async Task<IActionResult> Create()
        {
            ...
            {
                InventorySelectList = new SelectList(await _bll.Inventories.AllAsync(), nameof(Inventory.Id), nameof(Inventory.Description)),
        ...
        public async Task<IActionResult> Create(ProductCreateViewModel vm)
        {
            ...
            vm.InventorySelectList = new SelectList(await _bll.Inventories.AllAsync(), nameof(Inventory.Id), nameof(Inventory.Description));
        ...
        public async Task<IActionResult> Edit(int id, ProductCreateViewModel vm)
        {
            ...
            vm.InventorySelectList = new SelectList(await _bll.Inventories.AllAsync(), nameof(Inventory.Id),
