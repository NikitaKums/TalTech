...
namespace WebApp.Areas.Admin.Controllers
{
    ...
    public class ReturnsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string sortOrder, string currentFilter, string searchString, int? pageNumber)
        {
            ...
            var @return = await _bll.Returns.AllAsync(sortOrder, searchString, pageNumber ?? 1, 10);
            return View(PaginatedList<BLL.App.DTO.DomainLikeDTO.Return>.Create(@return, pageNumber ?? 1, 10, 
                await _bll.Returns.CountDataAmount(searchString)));
        }
        ...
        public RedirectToActionResult AddProductToReturn(int id)
        {
