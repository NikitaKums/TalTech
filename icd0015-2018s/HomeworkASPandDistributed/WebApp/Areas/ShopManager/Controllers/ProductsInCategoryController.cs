...
namespace WebApp.Areas.ShopManager.Controllers
{
    ...
    public class ProductsInCategoryController : Controller
    {
        ...
        {
            var productInCategory = await _bll.ProductsInCategory.AllAsyncByShop(User.GetShopId());
        ...
        public async Task<IActionResult> Create(int? id)
        {
            ...
            {
                CategorySelectList = new SelectList(await _bll.Categories.AllAsyncByShop(User.GetShopId(), null, null, null, null), nameof(Category.Id), nameof(Category.CategoryName)),
        ...
        public async Task<IActionResult> Create(ProductInCategoryCreateViewModel vm)
        {
            ...
            vm.CategorySelectList = new SelectList(await _bll.Categories.AllAsyncByShop(User.GetShopId(), null, null, null, null), nameof(Category.Id),
                nameof(Category.CategoryName));
            vm.ProductSelectList = new SelectList(await _bll.Products.AllAsyncByShopForDropDown(User.GetShopId()), nameof(Product.Id),
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var vm = new ProductInCategoryCreateViewModel()
            {
                ...
                CategorySelectList = new SelectList(await _bll.Categories.AllAsyncByShop(User.GetShopId(), null, null, null, null), nameof(Category.Id),
                    nameof(Category.CategoryName)),
                ProductSelectList = new SelectList(await _bll.Products.AllAsyncByShopForDropDown(User.GetShopId()), nameof(Product.Id),
                    nameof(Product.ProductName))
            };
            return View(vm);
        }
