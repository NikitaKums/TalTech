    ...
    public class ShippersController : Controller
    {
        ...
        public async Task<IActionResult> Index(string sortOrder, string currentFilter, string searchString, int? pageNumber)
        {
            ...
            return View(PaginatedList<BLL.App.DTO.DomainLikeDTO.Shipper>.Create(shipper, pageNumber ?? 1, 10, 
                await _bll.Shippers.CountDataAmount(User.GetShopId(), searchString)));
        }
       ...
       /* public async Task<IActionResult> Edit(int? id)
        ...
        /*[HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ShipperName,ShipperAddress,PhoneNumber,Id")] Shipper shipper)
        {
            if (id != shipper.Id)
            {
                return NotFound();
