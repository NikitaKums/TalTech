        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (await _userManager.IsInRoleAsync(user, "ShopManager"))
                    {
                        _logger.LogInformation("User(ShopManager) logged in.");
                        return RedirectToAction("Index", "Home", new {area = "ShopManager"});
                    }
